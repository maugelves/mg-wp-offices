...
function xep_after_theme_setup(){
	load_plugin_textdomain(MGWPOFF_DOMAIN,false, MGWPOFF_FOLDER . '/languages');
}
 ...
 */
function mgwpoff_check_plugin_dependencies() {
	/**
...
add_action( 'tgmpa_register', 'mgwpoff_check_plugin_dependencies' );